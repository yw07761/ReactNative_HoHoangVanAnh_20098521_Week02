...
const eatingTooMuch = sarahsDog.curFood > sarahsDog.recommendedFood * 1.1;
const eatingTooLittle = sarahsDog.curFood < sarahsDog.recommendedFood * 0.9;

console.log(`Sarah's dog is eating ${eatingTooMuch ? 'too much' : eatingTooLittle ? 'too little' : 'the correct amount'}`);

// 3. Arrays for owners of dogs eating too much or too little
